...
ELSE
BEGIN
UPDATE MOCTF SET TF200 = TF200 + @QUANTITY, TF201 = ISNULL(TF201,0) + @WEIGHT
...
SELECT TOP 1 ADMMF.COMPANY,ADMMF.MF001, ADMMF.MF004,@DATE,NULL,NULL,
	1,@HOUR,'TLAN','TLAN',NULL,NULL, NULL,
	@SP,@WAREHOUSE,@LOCATION,0,0,0,@QUANTITY,0,0,0,'',@DATE,'', @WEIGHT,@LOCATION
	FROM MOCTG
INNER JOIN ADMMF ON ADMMF.MF001 = @USER
WHERE TG001 = @TF001 AND TG002 = @TF002 AND TG003 = @STT
END
...
MODI_TIME = @HOUR, MODI_AP = 'TLAN', MODI_PRID = 'TLAN',
MC007 = MC007 + @QUANTITY, MC014 = ISNULL(MC014,0) + @WEIGHT, MC012 = @DATE
...
MODI_TIME = @HOUR, MODI_AP = 'TLAN', MODI_PRID = 'TLAN',
MM005 = MM005+@QUANTITY,MM006 = ISNULL(MM006,0)+@WEIGHT, MM008 = @DATE
...
MODI_TIME = @HOUR, MODI_AP = 'TLAN', MODI_PRID = 'TLAN',
MB064 =MB064 +@QUANTITY,MB089 = ISNULL(MB089,0)+@WEIGHT
WHERE MB001 = @SP
...
UPDATE SFCTA SET MODIFIER = @USER, MODI_DATE =@DATE,FLAG = FLAG+1
,MODI_TIME = @HOUR, MODI_AP ='TLAN', MODI_PRID ='TLAN',
TA017 = TA017+@QUANTITY, TA045 = ISNULL(TA045,0) + @WEIGHT
WHERE TA001 = @TA001 and TA002 = @TA002 and TA003 = '0020'
END
